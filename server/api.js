...
import serviceAccount from './firebase/web-prog-1005-7-firebase-adminsdk-fbsvc-1c2d0dd672.json' with { type: "json" };
...
app.post('/api/insert', (req, res) => {
  try {
    ...
    const newBook = { bookTitle: bookTitle, bookAuthor: bookAuthor };
    // books.push(newBook);
    addBook(newBook);
